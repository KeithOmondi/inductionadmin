...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <>
      {/* 📱 MOBILE TOP BAR */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-[100] bg-white border-b border-slate-200 px-5 py-3 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2">
          <div className="bg-[#355E3B] p-1.5 rounded-md">
            <Gavel size={18} className="text-[#C5A059]" />
          </div>
          <span className="text-[#355E3B] font-serif font-bold text-sm">
            Registry Admin
          </span>
        </div>
      ...
      <aside
        className={`
          fixed lg:sticky
          top-[56px] lg:top-[73px]
          left-0
          z-[95]
          w-72 lg:w-64
          bg-white
          h-[calc(100vh-56px)] lg:h-[calc(100vh-73px)]
          overflow-y-auto
      ...
      >
        ...
        <div className="space-y-4 mt-6">
          <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 hidden lg:block">
            ...
            <p className="text-[10px] text-[#355E3B] font-bold">
